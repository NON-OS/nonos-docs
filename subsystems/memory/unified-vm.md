...
is on the [paging manager](paging-manager.md) page, the frame allocator step 5 probes is on the
[physical frames](physical-frames.md) page, and the heap and page allocator this brings up are on the
[heap](heap.md) and [page allocator](page-allocator.md) pages.
