...
the [inventory](../capsules.md) is the flat table of handles, ports, and capabilities, and this catalog
...
[drivers](../drivers.md) contract table and the [networking subsystem](../../subsystems/networking/README.md)),
...
manifest declared. A capsule is spawned through [verified spawn](../../security/capsules-and-trust.md),
so it runs only if its signatures check and its requested capabilities are in policy, and it reaches
other capsules only through [IPC](../../subsystems/ipc/README.md) to their named endpoints. Reading an
