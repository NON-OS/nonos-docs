...
[capsule_entropy](entropy.md): `u32 magic ("NOCX" = 0x4E4F4358), u16 version (1), u16 op, u16 flags, u16
...
- The [market](market.md) verifies its signed catalog index through `crypto_ed25519_verify` rather than
...
`crypto_pool` resolves on port 4102, so callers such as the [market](market.md) can reach it.
