...
[boot splash](boot-splash.md) through `mk_attest_status`, not by this capsule. The source is
...
`mk_attest_status` by the [boot splash](boot-splash.md), not by this capsule
