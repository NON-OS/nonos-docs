...
| `net.nym` | `service:4470:net.nym` | `0x0013d` | healthcheck, set gateway, open session, send, receive, cover tick, close, set topology, set credential, create SURB, send reply, set timing, set authority, sync directory, topology status, timing status, set destination, set identity | `userland/capsule_net_nym/src/main.rs:43` | `userland/capsule_net_nym/Capsule.mk:11`, `userland/capsule_net_nym/Capsule.mk:13`, `userland/capsule_net_nym/src/protocol/ops.rs:17` |
| `net.socks5` | `service:4908:net.socks5` | `0x0013d` | RFC 1928 as raw bytes rather than a framed request: method selection, then CONNECT | `userland/capsule_socks5/src/main.rs:37` | `userland/capsule_socks5/Capsule.mk:5`, `userland/capsule_socks5/Capsule.mk:11`, `userland/capsule_socks5/Capsule.mk:13` |
| `net.ip` | port 4479, registered by `net.core` | inherited from `net.core` | send packet, poll packet, for a named protocol; ICMP today | `userland/capsule_net_core/src/server/handlers/ip/dispatch.rs:24` | `userland/capsule_net_core/src/register.rs:23`, `userland/capsule_net_core/src/register.rs:29`, `userland/capsule_net_core/src/protocol/ip.rs:22` |
