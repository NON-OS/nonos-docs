...
[ZeroState](../../subsystems/memory/zeroization.md) posture, mirroring the kernel [ramfs](../ramfs/README.md)'s
zero-on-drop.
...
unlike the encrypted [ramfs](../ramfs/README.md) it stores plaintext and relies on zeroization rather than at-rest
