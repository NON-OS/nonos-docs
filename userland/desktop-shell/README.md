...
the exhaustive reference; the [desktop overview](../desktop-fleet.md) is the short version.
...
- The splash never leaves the screen. The [boot splash](../boot-splash/README.md) polls `lookup("desktop_shell")`
