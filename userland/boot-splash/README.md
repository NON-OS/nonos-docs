...
version is the [desktop overview](../desktop-fleet.md).
...
The honest framing is the same one the [attest](../attest/README.md) page carries: the splash **displays** the
...
[wallpaper](../wallpaper/README.md), [login](../login/README.md), and [setup wizard](../setup-wizard/README.md) capsules carry: it can
...
Note the one identity quirk that the [desktop overview](../desktop-fleet.md) flags: the `Capsule.mk` reserves
...
- **It displays, it does not verify.** This is the point worth restating. The badge is
  ...
  measurement. The [attest](../attest/README.md) page and the [proof system](../../subsystems/proof-system/README.md)
