...
[Storage](../subsystems/storage/README.md).
...
| `installer` | Installer service with healthcheck, paid install admission, and VFS store capsule-load operations. | `userland/capsule_installer/src/protocol/types.rs:17` to `userland/capsule_installer/src/protocol/types.rs:19` | `userland/capsule_installer/src/server/runner.rs:26`, dispatch at `userland/capsule_installer/src/server/dispatch.rs:22` |
| `payment` | Payment service with healthcheck, pay, drain receipts, and list tokens operations. | `userland/capsule_payment/src/protocol/types.rs:17` to `userland/capsule_payment/src/protocol/types.rs:20` | `userland/capsule_payment/src/server/runner.rs:27`, dispatch at `userland/capsule_payment/src/server/dispatch.rs:25` |
