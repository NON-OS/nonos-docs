...
(`src/security/nonos_trust_anchor/schema.rs:47`). The current schema version is 1:
...
(`nonos_id_cert/verify/checks.rs:27`):
...
described on the [capabilities page](capabilities-and-tokens.md): one number
...
(`nonos_id_cert/verify/checks.rs:22`), in this order:
