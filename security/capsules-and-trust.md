...
[certificate page](certificate-schema.md); the manifest schema stage two reads is
on the [manifest page](manifest-schema.md); the attestation reason is on the
[attestation page](attestation.md).
