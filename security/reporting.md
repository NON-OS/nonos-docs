...
NØNOS is a from-scratch, capability-based microkernel. Its trust chain (hybrid
...
The [security model](security-model.md) sets out the threat model and the
trusted computing base a report is judged against, and
[rewards](../community/rewards.md) covers what a verified security fix pays.
